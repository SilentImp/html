...
Семантічно вірний HTML легче читати, розуміти та підтримувати. Це краще з точки зору доступності, нариклад для программ читання з екрану. Не кажучи вже про роботів та всіляких парсерах, включаючи пошукових ботів.
...
Таким чином ми матимемо надійне рішення, в той самий час, як користувач отримає максімум, який дозволяє його платформа, від програмного продукту.
...
Навіть як у вашому браузері все виглядає добре, у браузері користувача сторінка може виглядати зламанною, бо корекція помилок працює інакше в різних браузерах. Окрім цього це може збити з пантелику розробників, язі будуть супроводжувати той код. Потенційно валідний HTML може бути корисним з точки зору пошукової оптимізації та доступності.
